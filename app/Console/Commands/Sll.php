...
class Sll extends Command
{
     ...
     * @var string
     */
    protected $signature = 'command:sllsitemap';
    ...
    public function handle(){
        ...
        $domains=str_replace("\r",'',str_replace("\n",'',$universal));
        $this->header=[
        ...
        foreach ($domains as $domain){
            ...
            if($reArray["err_no"] == 0){
                ...
                if(!$r){
                    ...
                    echo $domain."-----------为空\r\n";
                    $handle=fopen(public_path('/sll.txt'),"a+");
                    fwrite($handle,"为空-----------".$domain."\r\n");
                    fclose($handle);
                    continue;
                }
                if($r['status']===-1){
