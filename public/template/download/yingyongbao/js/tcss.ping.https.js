(function() {
        ...
        t.prototype = {
            ...
            run: function() {
                ...
                1 == A && (a = this.getParameter("tcss_rp_dm", g.URL),
                a != Tcss.dm && (a = this.url.join("").replace(/\?dm=(.*?)\&/, "?dm=" + a + "&"),
                    this.sendInfo(a)));
            ...
            getRefInfo: function(a) {
                ...
                -1 < m && (m = e.match(/(\w+):\/\/([^\:|\/]+)(\:\d*)?(.*\/)([^#|\?|\n]+)?(#.*)?(\?.*)?/i)) && (c = m[2],
                    b = m[4] + (m[5] ? m[5] : ""));
                -1 != e.indexOf("?") && (m = e.indexOf("?") + 1,
                    d = e.substr(m));
                e = c;
                f.virtualRefDomain && ("-" != c && u.push("ard=" + c),
                    c = f.virtualRefDomain);
                f.virtualRefURL && ("-" != b && u.push("aru=" + escape(b)),
                    b = f.virtualRefURL);
                var k;
                a && (k = c + b,
                    c = "ADTAG",
                ...
                e = l.hostname;
                f.inner && (e = "," + e + "," + f.inner + ",");
                "-" == p || -1 < ("," + e + ",").indexOf(p) || 1 == A || (b = escape((p + b).substring(0, 128)),
                b != c && (z = 2),
                    h.setCookie("ts_refer", !0, b));
                Tcss.rdm = p;
                Tcss.rurl = B;
            ...
            getMainEnvInfo: function() {
                ...
                try {
                    var c = "-"
                        ...
                        , h = 0
                        , g = navigator;
                    self.screen && (c = screen.width + "x" + screen.height,
            ...
            getElementPos: function(a) {
                ...
                if (a.getBoundingClientRect)
                    return c = a.getBoundingClientRect(),
                    ...
                    if (b != a)
                        for (; b; )
                            d[0] += b.offsetLeft,
                                d[1] += b.offsetTop,
                                b = b.offsetParent;
                    if (-1 < c.indexOf("opera") || -1 < c.indexOf("safari") && "absolute" == a.style.position)
        ...
        window.pgvMain = function(a, c) {
            var b = "";
            c ? (b = c,
                _ver = "tcsso.3.1.5") : (b = a,
                _ver = "tcss.3.1.5");
            try {
                v && ("undefined" != typeof pvRepeatCount && 1 == pvRepeatCount ? (r = 1,
                    pvRepeatCount = 2) : r = 2),
                1 == r && (r = 2,
                    (new t(b)).run())
            } catch (d) {}
