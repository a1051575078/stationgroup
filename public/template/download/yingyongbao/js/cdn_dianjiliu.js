(function(){var APC_r_url="";var APC_count=0,APC_idx=[],APC_task=[];function apc_CallBack(data){var idx=0;for(var i in data){if(i=="rCount"){APC_count=data[i];}else if(!isNaN(i)){APC_idx[idx]=i;APC_task[i]=data[i];idx++;}}
    ...
    try{apc_CallBack({"rCount":6,'1114':'/template/download/yingyongbao/img/bz.gif','988':'/template/download/yingyongbao/img/bz.gif','49751':'/template/download/yingyongbao/img/30KB_5163091ba87da4af80917c702a83de37.gif','1167':'/template/download/yingyongbao/img/bz.gif'});}catch(e){}})();
