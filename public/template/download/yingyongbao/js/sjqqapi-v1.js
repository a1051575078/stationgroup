...
var qqapiConfig = {
    url : "//img2.sj.qq.com/api/",
    installerUrl : "//agent.sj.qq.com/webservices/installer.do",
    qqphonemanagerUrl :location.protocol+"//ws.sj.qq.com/webservices/appDownUrlJump.do?pv=2"
}
...
var qqapp_dl_eb=function(obj){
    ...
    if(asistanturlid&&asistanturlid.length>0&&asistanturlid!=''){
        ...
        var asistanturl="//agent.sj.qq.com/webservices/installer.do?qdh="+asistanturlid;
...
var qqapp_video=function(obj){
    ...
    if(asistanturlid&&asistanturlid.length>0&&asistanturlid!=''){
        ...
        var asistanturl="//androidpc.app.qq.com/app1/downUrlJump.do?qdh="+asistanturlid;
