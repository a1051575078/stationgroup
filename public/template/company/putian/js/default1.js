...
Type.registerNamespace('Sys');Sys.Res={
    "argumentInteger":"å€¼å¿…é¡»ä¸ºæ•´æ•°ã€‚","invokeCalledTwice":"æ— æ³•è°ƒç”¨ invoke å¤šæ¬¡ã€‚","webServiceFailed":"æœåŠ¡å™¨æ–¹æ³•â€œ{0}â€å¤±è´¥ï¼Œå¹¶å‘ç”Ÿä»¥ä¸‹é”™è¯¯: {1}","argumentType":"æ— æ³•å°†å¯¹è±¡è½¬æ¢ä¸ºæ‰€éœ€ç±»åž‹ã€‚","argumentNull":"å€¼ä¸èƒ½ä¸º nullã€‚","scriptAlreadyLoaded":"å·²å¤šæ¬¡å¼•ç”¨è„šæœ¬â€œ{0}â€ã€‚å¦‚æžœæ˜¾å¼å¼•ç”¨ Microsoft AJAX è„šæœ¬ï¼Œè¯·å°† ScriptManager çš„ MicrosoftAjaxMode å±žæ€§è®¾ç½®ä¸º Explicitã€‚","scriptDependencyNotFound":"åŠ è½½è„šæœ¬â€œ{0}â€å¤±è´¥ï¼Œå› ä¸ºå®ƒä¾èµ–äºŽè„šæœ¬â€œ{1}â€ã€‚","formatBadFormatSpecifier":"æ ¼å¼è¯´æ˜Žç¬¦æ— æ•ˆã€‚","requiredScriptReferenceNotIncluded":"â€œ{0}â€è¦æ±‚æ‚¨å·²åŒ…æ‹¬å¯¹â€œ{1}â€çš„è„šæœ¬å¼•ç”¨ã€‚","webServiceFailedNoMsg":"æœåŠ¡å™¨æ–¹æ³•â€œ{0}â€å¤±è´¥ã€‚","argumentDomElement":"å€¼å¿…é¡»ä¸º DOM å…ƒç´ ã€‚","invalidExecutorType":"æœªèƒ½ä»Ž {0} ä¸­åˆ›å»ºæœ‰æ•ˆçš„ Sys.Net.WebRequestExecutorã€‚","cannotCallBeforeResponse":"responseAvailable ä¸º false æ—¶æ— æ³•è°ƒç”¨ {0}ã€‚","actualValue":"å®žé™…å€¼æ˜¯ {0}ã€‚","enumInvalidValue":"â€œ{0}â€å¯¹äºŽæžšä¸¾ {1} ä¸æ˜¯æœ‰æ•ˆçš„å€¼ã€‚","scriptLoadFailed":"æœªèƒ½åŠ è½½è„šæœ¬â€œ{0}â€ã€‚","parameterCount":"å‚æ•°è®¡æ•°ä¸åŒ¹é…ã€‚","cannotDeserializeEmptyString":"æ— æ³•ååºåˆ—åŒ–ç©ºå­—ç¬¦ä¸²ã€‚","formatInvalidString":"è¾“å…¥å­—ç¬¦ä¸²çš„æ ¼å¼ä¸æ­£ç¡®ã€‚","invalidTimeout":"å€¼å¿…é¡»å¤§äºŽæˆ–ç­‰äºŽé›¶ã€‚","cannotAbortBeforeStart":"æ‰§è¡Œå™¨å°šæœªå¯åŠ¨æ—¶æ— æ³•ä¸­æ­¢ã€‚","argument":"å€¼ä¸åœ¨é¢„æœŸçš„èŒƒå›´å†…ã€‚","cannotDeserializeInvalidJson":"æ— æ³•ååºåˆ—åŒ–ã€‚æ•°æ®æœªå¯¹åº”äºŽæœ‰æ•ˆçš„ JSONã€‚","invalidHttpVerb":"httpVerb ä¸èƒ½è®¾ç½®ä¸ºç©ºå­—ç¬¦ä¸²æˆ– null å­—ç¬¦ä¸²ã€‚","nullWebRequest":"æ— æ³•è°ƒç”¨å¸¦æœ‰ null webRequest çš„ executeRequestã€‚","eventHandlerInvalid":"æœªé€šè¿‡ Sys.UI.DomEvent.addHandler æ–¹æ³•æ·»åŠ å¤„ç†ç¨‹åºã€‚","cannotSerializeNonFiniteNumbers":"æ— æ³•åºåˆ—åŒ–æ— é™æ•°ã€‚","argumentUndefined":"å€¼ä¸èƒ½æ˜¯æœªå®šä¹‰çš„ã€‚","webServiceInvalidReturnType":"æœåŠ¡å™¨æ–¹æ³•â€œ{0}â€è¿”å›žäº†æ— æ•ˆç±»åž‹ã€‚æœŸæœ›çš„ç±»åž‹: {1}","servicePathNotSet":"å°šæœªè®¾ç½® Web æœåŠ¡çš„è·¯å¾„ã€‚","argumentTypeWithTypes":"ç±»åž‹â€œ{0}â€çš„å¯¹è±¡æ— æ³•è½¬æ¢ä¸ºç±»åž‹â€œ{1}â€ã€‚","cannotCallOnceStarted":"å¯åŠ¨åŽå°†æ— æ³•è°ƒç”¨ {0}ã€‚","badBaseUrl1":"åŸº URL ä¸åŒ…å« ://ã€‚","badBaseUrl2":"åŸº URL ä¸åŒ…å«å¦ä¸€ä¸ª /ã€‚","badBaseUrl3":"åœ¨åŸº URL ä¸­æ‰¾ä¸åˆ°æœ€åŽä¸€ä¸ª /ã€‚","setExecutorAfterActive":"æ— æ³•åœ¨æ‰§è¡Œå™¨å·²æ¿€æ´»ä¹‹åŽå¯¹å…¶è¿›è¡Œè®¾ç½®ã€‚","paramName":"å‚æ•°å: {0}","nullReferenceInPath":"è®¡ç®—æ•°æ®è·¯å¾„æ—¶å‘ç”Ÿç©ºå¼•ç”¨:â€œ{0}â€ã€‚","cannotCallOutsideHandler":"æ— æ³•åœ¨å®Œæˆçš„äº‹ä»¶å¤„ç†ç¨‹åºå¤–éƒ¨è°ƒç”¨ {0}ã€‚","cannotSerializeObjectWithCycle":"æ— æ³•åºåˆ—åŒ–å­å±žæ€§ä¸­å…·æœ‰å¾ªçŽ¯å¼•ç”¨çš„å¯¹è±¡ã€‚","format":"å·²æ ‡è¯†é¡¹ä¸­æœ‰ä¸€é¡¹çš„æ ¼å¼æ— æ•ˆã€‚","assertFailedCaller":"æ–­è¨€å¤±è´¥: {0}\r\nä½ç½®ä¸º {1}","argumentOutOfRange":"æŒ‡å®šçš„å‚æ•°å·²è¶…å‡ºæœ‰æ•ˆå€¼çš„èŒƒå›´ã€‚","webServiceTimedOut":"æœåŠ¡å™¨æ–¹æ³•â€œ{0}â€å·²è¶…æ—¶ã€‚","notImplemented":"æœªå®žçŽ°è¯¥æ–¹æ³•æˆ–æ“ä½œã€‚","assertFailed":"æ–­è¨€å¤±è´¥: {0}","invalidOperation":"å¯¹è±¡çš„å½“å‰çŠ¶æ€ä½¿è¯¥æ“ä½œæ— æ•ˆã€‚","breakIntoDebugger":"{0}\r\n\r\næ˜¯å¦ä¸­æ–­è‡³è°ƒè¯•ç¨‹åº?"};
...
Type.registerNamespace('Sys.WebForms');Sys.WebForms.Res={
    "PRM_UnknownToken":"æœªçŸ¥æ ‡è®°:â€œ{0}â€ã€‚","PRM_MissingPanel":"æœªèƒ½æ‰¾åˆ° ID ä¸ºâ€œ{0}â€çš„ UpdatePanelã€‚å¦‚æžœè¦åŠ¨æ€æ›´æ–°è¯¥ UpdatePanelï¼Œåˆ™å®ƒå¿…é¡»ä½äºŽå¦ä¸€ä¸ª UpdatePanel å†…éƒ¨ã€‚","PRM_ServerError":"åœ¨æœåŠ¡å™¨ä¸Šå¤„ç†è¯·æ±‚æ—¶å‡ºçŽ°æœªçŸ¥é”™è¯¯ã€‚æœåŠ¡å™¨è¿”å›žçš„çŠ¶æ€ç ä¸º: {0}","PRM_ParserError":"æœªèƒ½åˆ†æžä»ŽæœåŠ¡å™¨æ”¶åˆ°çš„æ¶ˆæ¯ã€‚ä¹‹æ‰€ä»¥å‡ºçŽ°æ­¤é”™è¯¯ï¼Œå¸¸è§çš„åŽŸå› æ˜¯: åœ¨é€šè¿‡è°ƒç”¨ Response.Write() ä¿®æ”¹å“åº”æ—¶ï¼Œå°†å¯ç”¨å“åº”ç­›é€‰å™¨ã€HttpModule æˆ–æœåŠ¡å™¨è·Ÿè¸ªã€‚\r\nè¯¦ç»†ä¿¡æ¯: {0}","PRM_TimeoutError":"æœåŠ¡å™¨è¯·æ±‚è¶…æ—¶ã€‚","PRM_ParserErrorDetails":"åˆ†æžé™„è¿‘çš„â€œ{0}â€æ—¶å‡ºé”™ã€‚","PRM_CannotRegisterTwice":"ä¸èƒ½åˆå§‹åŒ– PageRequestManager å¤šæ¬¡ã€‚"};
...
(function() {
    function loadHandler() {
        ...
        hf.value += ';;System.Web.Extensions, Version=4.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35:en:2d39c544-8ec0-4a2c-bc21-04e23af02570:ea597d4b:b25378d2;Telerik.Web.UI, Version=2013.2.717.40, Culture=neutral, PublicKeyToken=121fae78165ba3d4:en:dae8717e-3810-4050-96d3-31018e70c6e4:16e4e7cd:f7645509:ed16cbdc';
