window._bd_share_main.F.module("share/api_base", function(e, t, n) {
    ...
    t.ApiBase = i.create(function(e) {
        ...
        function o(n) {
            ...
            if (i && i.data)
                if (n.cmd == "more" || n.cmd == "count")
                    window._bd_share_main.F.use("component/pop_dialog", function(t) {
                        var r = t.Dialog;
                        r.un(),
                            r.on("clickact", o),
                            r.on("mouseenter", s),
                    ...
                    var a;
                    r.type(e.onBeforeClick) == "function" && (a = r.extend({}, e),
                        a = e.onBeforeClick(n.cmd, a));
                    var f = r.extend({}, e, a, {
                        __type: i.data.type,
